...
let {SignUpValidator,LoginValidator,ChangePassValidator,ForgotPassword,ResetPassword,validate} = require('../utils/validator')
...
router.post('/change_password', check_authentication,ChangePassValidator,validate,
...
router.post('/forgotpassword',ForgotPassword,validate, async function (req, res, next) {
    try {
...
router.post('/resetpassword/:token',ResetPassword,validate,async function (req, res, next) {
    try {
