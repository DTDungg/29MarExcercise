...
let {UserValidator,validate} = require('../utils/validator')
...
router.post('/',UserValidator,validate, async function (req, res, next) {
  try {
    let body = req.body;
...
router.put('/:id',UserValidator,validate, async function (req, res, next) {
  try {
    let body = req.body;
